"""
Django settings for depts project.
...
SECRET_KEY = 'django-insecure-_os3zv@$jgm+v)&p-%0joo&3fvqew*+_v85-ckl5_=yx&n_=@u'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app_bets.context_processors.bets_texts',
            ],
        },
    },
]
...
# Устанавливаем часовой пояс (например, Московское время)
