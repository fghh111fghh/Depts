...
from .models import League, Team, TeamAlias, Season, Match, Bank, Bet
...
class MatchAdmin(admin.ModelAdmin):
    list_display = ['date', 'home_team', 'away_team', 'league', 'home_score_reg', 'away_score_reg']
    list_filter = ['league', 'season', 'finish_type']
